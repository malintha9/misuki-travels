...
function theme_widgets_init() {
    register_sidebar(array(
            'name'          => __('Widget Area 1', 'japantours'),
            'id'            => 'area_1',
            'description'   => __('Add widgets here to appear in your sidebar.', 'japantours'),
...
register_sidebar(array(
            'name'          => __('Widget Area 2', 'japantours'),
            'id'            => 'area_2',
            'description'   => __('Add widgets here to appear in your sidebar.', 'japantours'),
            'before_widget' => '<widget id="%1$s" name="%1$s" class="widget %2$s">',
            'after_widget'  => '</widget>',
...
register_sidebar(array(
            'name'          => __('Widget Area 3', 'japantours'),
            'id'            => 'area_3',
            'description'   => __('Add widgets here to appear in your sidebar.', 'japantours'),
            'before_widget' => '<widget id="%1$s" name="%1$s" class="widget %2$s">',
            'after_widget'  => '</widget>',
