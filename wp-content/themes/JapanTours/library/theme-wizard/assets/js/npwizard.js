var Npwizard = (function($){
    ...
    var callbacks = {
        ...
        theme_appearance_update: function() {
            ...
            function stopWithError(msg) {
                var settingsUrl = npwizard_params.settingsUrl || '#';
                $('.npwizard-wrap')
            ...
            var _ajax_nonce = npwizard_params.wpnonceThemeAppearance;

            $.ajax({
                url: npwizard_params.urlContent,
                type: 'POST',
                data: {
    ...
    function ContentManager(btnText){
        ...
        if (btnText === "Import Products") {
            //products import
            name = 'products';
            npAction = npwizard_params.actionImportProducts
        } else if (btnText === "Replace previously imported Products") {
            //products replace
            name = 'products';
            npAction = npwizard_params.actionReplaceProducts
