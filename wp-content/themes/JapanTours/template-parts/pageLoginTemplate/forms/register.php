<form action="<?php echo wp_registration_url(); ?>" method="post" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;"><!--login_form_usernameGroup-->
        <div class="u-form-group u-form-name"><!--login_form_usernameLabel-->
          ...
          <input type="text" placeholder="<?php _e( 'Username' ); ?>" id="username-a30d" name="user_login" class="u-input u-input-rectangle u-none u-input-1" required=""><!--/login_form_username-->
        </div><!--/login_form_usernameGroup--><!--login_form_passwordGroup-->
        <div class="u-form-group u-form-password"><!--login_form_passwordLabel-->
          <label for="email-a30d" class="u-label" name=""><?php _e( 'Email' ); ?></label><!--/login_form_passwordLabel--><!--login_form_password-->
          <input type="text" placeholder="<?php _e( 'Email' ); ?>" id="email-a30d" name="user_email" class="u-input u-input-rectangle u-none u-input-2" required=""><!--/login_form_password-->
